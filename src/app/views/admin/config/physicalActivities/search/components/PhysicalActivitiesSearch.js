...
const PhysicalActivitiesSearch = () => {
                                    ...
                                    <Form>
                                        <CRow>
                                            ...
                                            <CCol sm="12" md="6" lg="3">
                                                <CFormGroup>
                                                    <CLabel htmlFor="activityName">Activity</CLabel>
                                            ...
                                            <CCol sm="12" md="6" lg="3">
                                                <CFormGroup>
                                                    <CLabel htmlFor="physicalActivityCategoryID">Activity
                                                        Category</CLabel>
...
export default PhysicalActivitiesSearch;
