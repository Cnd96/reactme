...
const DietaryHabitCategorySearchForm = () => {
                                    ...
                                    <Form>
                                        <CRow>
                                            ...
                                            <CCol sm="12" md="6" lg="3">
                                                <CFormGroup>
                                                    <CLabel htmlFor="dietaryCategory">Dietary Category</CLabel>
                                            ...
                                            <CCol sm="12" md="6" lg="3">
                                                ...
                                                <CTooltip
                                                    content={'Add new Dietary Category'}
...
export default DietaryHabitCategorySearchForm;