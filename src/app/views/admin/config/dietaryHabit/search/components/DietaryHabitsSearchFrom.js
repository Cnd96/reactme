                                    ...
                                    <Form>
                                        <CRow>
                                            ...
                                            <CCol sm="12" md="6" lg="3">
                                                <CFormGroup>
                                                    <CLabel htmlFor="dietaryHabit">Dietary Quiz</CLabel>
                                            ...
                                            <CCol sm="12" md="6" lg="3">
                                                <CFormGroup>
                                                    <CLabel htmlFor="dietaryCategoryID">Habit Category</CLabel>
...
export default DietaryHabitsSearchFrom;